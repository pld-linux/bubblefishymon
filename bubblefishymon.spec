...
improved.  Many new features have been added.

%description -l pl
Program jest dokowalnym monitorem obci±¿enia procesora, pamiêci, partycji
wymiany oraz load average.  Jest on oparty na aplecie GNOME BubbleMon, ale
od tego czasu wprowadzono wiele poprawek oraz dodano now± funkcjonalno¶æ.
...
This program is a dockapp-style CPU, memory, swap and load average monitor.
Based on the GNOME BubbleMon applet, this program has been considerably
improved.  Many new features have been added.  This is gkrellm version of
bubblefishymon.
...
wymiany oraz load average.  Jest on oparty na aplecie GNOME BubbleMon, ale
od tego czasu wprowadzono wiele poprawek oraz dodano now± funkcjonalno¶æ.
Ten pakiet zawiera wersjê programu dla gkrellm.
